 ...
 * @author reuben
 */
@Named(value = "viewAcceptedOfferManagedBean")
@SessionScoped
public class ViewAcceptedOfferManagedBean implements Serializable {
    ...
    public ViewAcceptedOfferManagedBean() {
    ...
    public List<OfferEntity> retrieveOffers() {
        ...
        List<OfferEntity> acceptedOffers = new ArrayList<>();
        if (!offerItem.isEmpty()) {
            for (OfferEntity o : offerItem) {
                if (o.isAccepted()) {
